...
| `add_symbol` | function | `minigcc.c:1344` | `static void add_symbol(const char *name, int is_global, int size, int pointed, int is_array, int ...` |
| `additive_expr` | function | `minigcc.c:1942` | `static void additive_expr(void)` |
| `arg_reg` | function | `minigcc.c:1405` | `static const char *arg_reg(int i)` |
| `assignment_expr` | function | `minigcc.c:2212` | `static void assignment_expr(void)` |
| `bitwise_and_expr` | function | `minigcc.c:2118` | `static void bitwise_and_expr(void)` |
| `bitwise_or_expr` | function | `minigcc.c:2142` | `static void bitwise_or_expr(void)` |
| `bitwise_xor_expr` | function | `minigcc.c:2130` | `static void bitwise_xor_expr(void)` |
| `conditional_expr` | function | `minigcc.c:2194` | `static void conditional_expr(void)` |
| `data_directive` | function | `minigcc.c:3325` | `static const char *data_directive(int size)` |
| `emit` | function | `minigcc.c:1267` | `static void emit(const char *s)` |
| `emit_asciz_body` | function | `minigcc.c:1309` | `static void emit_asciz_body(const char *s)` |
| `emit_float_consts` | function | `minigcc.c:3605` | `static void emit_float_consts(void)` |
| `emit_global_bss` | function | `minigcc.c:3333` | `static void emit_global_bss(const char *name, int is_static, int size)` |
| `emit_global_data_head` | function | `minigcc.c:3340` | `static void emit_global_data_head(const char *name, int is_static)` |
| `emit_global_initializer` | function | `minigcc.c:3390` | `static int emit_global_initializer(const char *name, int is_static, int *size,
                  ...` |
| `emit_i` | function | `minigcc.c:1281` | `static void emit_i(const char *fmt, int v)` |
| `emit_is` | function | `minigcc.c:1293` | `static void emit_is(const char *fmt, int v, const char *s)` |
| `emit_label` | function | `minigcc.c:1327` | `static void emit_label(int label)` |
| `emit_s` | function | `minigcc.c:1287` | `static void emit_s(const char *fmt, const char *s)` |
| `emit_si` | function | `minigcc.c:1299` | `static void emit_si(const char *fmt, const char *s, int v)` |
| `emit_string_pool` | function | `minigcc.c:3615` | `static void emit_string_pool(void)` |
| `equality_expr` | function | `minigcc.c:2069` | `static void equality_expr(void)` |
| `error` | function | `minigcc.c:587` | `static void error(const char *msg)` |
| `exit` | function | `minigcc.c:591` | `exit(EXIT_FAILURE);` |
| `fclose` | function | `minigcc.c:668` | `fclose(f);` |
| `find_macro` | function | `minigcc.c:276` | `static int find_macro(const char *name)` |
| `find_symbol` | function | `minigcc.c:1334` | `static int find_symbol(const char *name)` |
| `fprintf` | function | `minigcc.c:589` | `fprintf(stderr, "%s:%d: Error at token '%s': %s\n", current_file ? current_file : "(unknown)", line, token, msg);` |
| `fputc` | function | `minigcc.c:1272` | `fputc('%', output);` |
| `free` | function | `minigcc.c:717` | `free(buf);` |
| `fseek` | function | `minigcc.c:707` | `fseek(f, 0, SEEK_END);` |
| `get_dir_from_path` | function | `minigcc.c:645` | `static void get_dir_from_path(const char *path, char *dir, int dir_sz)` |
| `handle_postfix` | function | `minigcc.c:1729` | `static void handle_postfix(int is_lvalue)` |
| `hash_init` | function | `minigcc.c:737` | `static void hash_init(void)` |
| `hash_name` | function | `minigcc.c:728` | `static int hash_name(const char *name)` |
| `intern_string` | function | `minigcc.c:3373` | `static int intern_string(const char *text)` |
| `is_file_processed` | function | `minigcc.c:624` | `static int is_file_processed(const char *path)` |
| `libc_global_name` | function | `minigcc.c:1415` | `static const char *libc_global_name(int i)` |
| `logical_and_expr` | function | `minigcc.c:2154` | `static void logical_and_expr(void)` |
| `logical_or_expr` | function | `minigcc.c:2174` | `static void logical_or_expr(void)` |
| `lvalue_address` | function | `minigcc.c:1677` | `static void lvalue_address(void)` |
| `macro_add` | function | `minigcc.c:438` | `static int macro_add(void)` |
| `macro_bitand` | function | `minigcc.c:512` | `static int macro_bitand(void)` |
| `macro_bitor` | function | `minigcc.c:540` | `static int macro_bitor(void)` |
| `macro_bitxor` | function | `minigcc.c:526` | `static int macro_bitxor(void)` |
| `macro_cmp` | function | `minigcc.c:472` | `static int macro_cmp(void)` |
| `macro_digit_val` | function | `minigcc.c:323` | `static int macro_digit_val(int c)` |
| `macro_eq` | function | `minigcc.c:495` | `static int macro_eq(void)` |
| `macro_fold` | function | `minigcc.c:582` | `static int macro_fold(void)` |
| `macro_hex_digit` | function | `minigcc.c:316` | `static int macro_hex_digit(int c)` |
| `macro_logand` | function | `minigcc.c:554` | `static int macro_logand(void)` |
| `macro_mul` | function | `minigcc.c:413` | `static int macro_mul(void)` |
| `macro_or_expr` | function | `minigcc.c:568` | `static int macro_or_expr(void)` |
| `macro_primary` | function | `minigcc.c:330` | `static int macro_primary(void)` |
| `macro_shift` | function | `minigcc.c:455` | `static int macro_shift(void)` |
| `macro_skipws` | function | `minigcc.c:312` | `static void macro_skipws(void)` |
| `macro_unary` | function | `minigcc.c:404` | `static int macro_unary(void)` |
| `main` | function | `minigcc.c:3625` | `int main(int argc, char **argv)` |
| `mark_file_processed` | function | `minigcc.c:633` | `static void mark_file_processed(const char *path)` |
| `match` | function | `minigcc.c:1262` | `static void match(int expected)` |
| `memcpy` | function | `minigcc.c:2421` | `memcpy(varname, token, nlen);` |
| `multiplicative_expr` | function | `minigcc.c:1878` | `static void multiplicative_expr(void)` |
| `my_isalnum` | function | `minigcc.c:819` | `static int my_isalnum(int c)` |
| `my_isalpha` | function | `minigcc.c:808` | `static int my_isalpha(int c)` |
| `my_isdigit` | function | `minigcc.c:814` | `static int my_isdigit(int c)` |
| `my_isspace` | function | `minigcc.c:798` | `static int my_isspace(int c)` |
| `next_token` | function | `minigcc.c:827` | `static void next_token(void)` |
| `parse_const_int` | function | `minigcc.c:3350` | `static int parse_const_int(long long *out)` |
| `parse_enum` | function | `minigcc.c:3157` | `static void parse_enum(void)` |
| `parse_function` | function | `minigcc.c:3030` | `static void parse_function(const char *name, int ret_type)` |
| `parse_program` | function | `minigcc.c:3454` | `static void parse_program(void)` |
| `pop_scope` | function | `minigcc.c:750` | `static void pop_scope(void)` |
| `push_scope` | function | `minigcc.c:742` | `static void push_scope(void)` |
| `read_include_file` | function | `minigcc.c:703` | `static char *read_include_file(const char *path)` |
| `relational_expr` | function | `minigcc.c:2016` | `static void relational_expr(void)` |
| `resolve_local_include` | function | `minigcc.c:664` | `static char *resolve_local_include(const char *target)` |
| `restore_parser_state` | function | `minigcc.c:240` | `static void restore_parser_state(ParserState *state)` |
| `rewind` | function | `minigcc.c:713` | `rewind(f);` |
| `safe_malloc` | function | `minigcc.c:593` | `static void *safe_malloc(size_t size)` |
| `safe_strcpy` | function | `minigcc.c:602` | `static void safe_strcpy(char *dst, const char *src, size_t dst_sz)` |
| `safe_strtoll` | function | `minigcc.c:611` | `static long safe_strtoll(const char *s)` |
| `save_parser_state` | function | `minigcc.c:215` | `static void save_parser_state(ParserState *state)` |
| `shift_expr` | function | `minigcc.c:1997` | `static void shift_expr(void)` |
| `skip_struct` | function | `minigcc.c:3206` | `static void skip_struct(void)` |
| `skip_typedef` | function | `minigcc.c:3270` | `static void skip_typedef(void)` |
| `snprintf` | function | `minigcc.c:1062` | `snprintf(token, MAX_TOKEN_LEN, "%d", macros[mi].value);` |
| `statement` | function | `minigcc.c:2373` | `static void statement(void)` |
| `strcpy` | function | `minigcc.c:1104` | `strcpy(float_const_str[float_const_count], token);` |
| `strncpy` | function | `minigcc.c:1350` | `strncpy(d, name, MAX_IDENT_LEN - 1);` |
| `truncate_symbols` | function | `minigcc.c:780` | `static void truncate_symbols(int start_idx)` |
| `unary` | function | `minigcc.c:1427` | `static void unary(void)` |
| `unary_expr` | function | `minigcc.c:1863` | `static void unary_expr(void)` |
