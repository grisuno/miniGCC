...
| `test_all.sh` | test_all.sh: feature test suite for miniGCC. For each tests/t_NAME.c: build a gc | root | 4 |
| `test_for.c` | include <stdio.h> | root | 1 |
...
| `tests/t_hexoct.c` | include <stdio.h> | tests | 2 |
| `tests/t_if.c` | include <stdio.h> | tests | 3 |
| `tests/t_include.c` | include <stdio.h> include "t_outer_h.h" include "t_outer_h.h" | tests | 2 |
| `tests/t_inline.c` | include <stdio.h> include "t_inline_h.h" | tests | 5 |
