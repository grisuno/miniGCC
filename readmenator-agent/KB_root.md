...
- Symbols:
  ...
  - `fprintf` (function, line 300) `fprintf(stderr, "%s:%d: Error at token '%s': %s\n", current_file ? current_file : "(unknown)", line, token, msg);`
  - `exit` (function, line 302) `exit(EXIT_FAILURE);`
  - `fclose` (function, line 379) `fclose(f);`
  - `fseek` (function, line 418) `fseek(f, 0, SEEK_END);`
  - `rewind` (function, line 424) `rewind(f);`
  - `free` (function, line 428) `free(buf);`
  - `snprintf` (function, line 774) `snprintf(token, MAX_TOKEN_LEN, "%d", macros[mi].value);`
  - `strcpy` (function, line 816) `strcpy(float_const_str[float_const_count], token);`
  - `fputc` (function, line 984) `fputc('%', output);`
  - `strncpy` (function, line 1062) `strncpy(d, name, MAX_IDENT_LEN - 1);`
  - `memcpy` (function, line 2132) `memcpy(varname, token, nlen);`
